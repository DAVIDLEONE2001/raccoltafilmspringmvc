		  ...
		  <div class="container">
				...
				<div class='card'>
				    ...
				    <div class='card-body'>
								...
								<form method="post" action= "${pageContext.request.contextPath }/film/list" class="row g-3">
								...
								<div class="col-md-6">
										<label for="registaSearchInput" class="form-label">Regista: <span class="text-danger">*</span></label>
											<input class="form-control" type="text" id="registaSearchInput"
												name="registaInput" value="">
										<input type="hidden" name="regista.id" id="registaId" value="">
								</div>
